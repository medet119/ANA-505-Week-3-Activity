...
#Such as number of columns, number of observations, number of rows, and woman data
...
#Such as Min, Median, Maximum, Mode, and Standard Deviation
#Task: Complete the comment above
summary(Anna_mydata)
...
#  first 2 lines of code show error in library(tibble), the other two lines show error in view
